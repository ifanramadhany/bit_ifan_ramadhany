...
import { ModalDetail, ModalEdit, ModalDelete, ItemTodoDone } from ".";


export default function ItemTodoUndone({ item, clearSearchHandler }) {
  ...
  return (
    <>
      ...
      {/* modal delete */}
      <ModalDelete modalDelete={modalDelete} modalDeleteClose={modalDeleteClose}/>
    </>
  );
}
